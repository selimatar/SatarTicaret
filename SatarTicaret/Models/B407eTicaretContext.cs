...
using SatarTicaret.Models.Mapping;

namespace SatarTicaret.Models
{
    public partial class B407eTicaretContext : DbContext
    {
        static B407eTicaretContext()
        {
            Database.SetInitializer<B407eTicaretContext>(null);
        }

        public B407eTicaretContext()
            : base("Name=B407eTicaretContext")
        {
        }
